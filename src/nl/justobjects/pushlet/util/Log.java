 ...
 * "logging.class" in pushlet.properties to your own logger
...
public class Log implements ConfigDefs {
	...
	static public void init() {
		try {
			logger = (DefaultLogger) Config.getClass(LOGGER_CLASS, "nl.justobjects.pushlet.util.DefaultLogger").newInstance();
		} catch (Throwable t) {
